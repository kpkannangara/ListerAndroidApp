...
import com.listerapp.lister.grocerystore.activity.BaseActivity;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        if (!cartList.isEmpty()) {
            for (int i = 0; i < cartList.size(); i++) {
                if (cartList.get(i).getTitle().equalsIgnoreCase(product.getImage())) {
            ...
            public void onClick(View v) {
                ...
                if (pQuantity >= 1) {
                    ...
                    for (int i = 0; i < cartList.size(); i++) {
                        ...
                        if (cartList.get(i).getTitle().equalsIgnoreCase(product.getName())) {
            ...
            public void onClick(View v) {
                ...
                if (Integer.parseInt(_quantity) != 0) {
                    ...
                    if (context instanceof ProductActivity) {
                        Cart cart = new Cart("", product.getName(), product.getImage(), _price, _quantity, _subtotal, product.getCategory(), product.getAmount());
                        cartList = ((BaseActivity) context).getCartList();
                        cartList.add(cart);
                        String cartStr = gson.toJson(cartList);
                        localStorage.setCart(cartStr);
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(localStorage.getCurrentUserISAdmin().equals("true")){
                    intent = new Intent(context, ProductViewAdminActivity.class);
                }else{
