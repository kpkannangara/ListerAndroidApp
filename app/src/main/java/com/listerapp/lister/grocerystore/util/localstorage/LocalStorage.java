package com.listerapp.lister.grocerystore.util.localstorage;
...
public class LocalStorage {
    ...
    public void setCurrentUserISAdmin(String isAdmin) {
        Editor editor = sharedPreferences.edit();
        editor.putString("isAdmin", isAdmin);
        editor.commit();
    }

    public String getCurrentUserISAdmin() {
        if (sharedPreferences.contains("isAdmin"))
            return sharedPreferences.getString("isAdmin", null);
        else return null;
    }
