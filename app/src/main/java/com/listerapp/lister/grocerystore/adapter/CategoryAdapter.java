...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.MyViewHolder> {
    ...
    List<Upload> categoryList;
    Context context;
    String Tag;

    public CategoryAdapter(List<Upload> categoryList, Context context) {
        this.categoryList = categoryList;
        this.context = context;
    }

    public CategoryAdapter(List<Upload> categoryList, Context context, String tag) {
        this.categoryList = categoryList;
        this.context = context;
        Tag = tag;
    }
...
//
        ...
        holder.btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                deleteCategory(categoryList.get(position).getName(), position);
            }
        });
